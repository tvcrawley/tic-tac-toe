...
var onAddToBoard = function onAddToBoard(event) {
  event.preventDefault();
...
// ADD TO BOARD
var addToBoard = function addToBoard(playerEntry) {
  // loop through the board
  // if index, change value
  store.game.cells.forEach(function (piece, index) {
...
var checkWinner = function checkWinner() {
  var diag1 = store.game.cells[0] === store.player && store.game.cells[4] === store.player && store.game.cells[8] === store.player;
  var diag2 = store.game.cells[2] === store.player && store.game.cells[4] === store.player && store.game.cells[6] === store.player;
  var row1 = store.game.cells[0] === store.player && store.game.cells[1] === store.player && store.game.cells[2] === store.player;
  var row2 = store.game.cells[3] === store.player && store.game.cells[4] === store.player && store.game.cells[5] === store.player;
  var row3 = store.game.cells[6] === store.player && store.game.cells[7] === store.player && store.game.cells[8] === store.player;
  var col1 = store.game.cells[0] === store.player && store.game.cells[3] === store.player && store.game.cells[6] === store.player;
  var col2 = store.game.cells[1] === store.player && store.game.cells[4] === store.player && store.game.cells[7] === store.player;
  var col3 = store.game.cells[2] === store.player && store.game.cells[5] === store.player && store.game.cells[8] === store.player;
  ...
  switch (true) {
    ...
    default:
      var count = 0;
      store.game.cells.forEach(function (piece) {
...
var gameStatsFailure = function gameStatsFailure(error) {
